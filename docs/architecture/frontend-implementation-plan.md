...
- `docs/design/mockups/current/flow-management-overview-v1.html`
- `docs/design/mockups/archive/public-mockups/flow-management-overview-v1.html`
...
- `docs/handoff/code-review-and-fix-requests.md`
...
- `docs/contracts`
- `docs/design`
- `docs/generated/superpowers/specs`
- `docs/generated/superpowers/plans`
...
- `docs/design/assets/current/*.png` 中的布局、信息层级和视觉密度
...
- `docs/design/assets/current/workbench-v1.png`
- `docs/handoff/handoff-next-tasks.md` section `Latest UI Shell Standard - 2026-05-18`
...
- `docs/design/mockups/current/ai-workflow-design-v1-final.html`
- `docs/design/mockups/archive/public-mockups/ai-workflow-design-v1-final.html`
...
- 断言点击 `生成流程草案` 后进入草案状态。
- 视觉回归建议用 Playwright 截图对比 `docs/design/mockups/archive/public-mockups/ai-workflow-design-v1-final.html`。
