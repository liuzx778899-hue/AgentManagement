...
## 2026-06-05 当前页面冻结前的协同硬规则

本节是当前最高优先级协同规则。用户正在继续调整页面到可接受状态，在用户明确确认并提交“当前定稿基线”之前，后续 Agent 和开发者必须遵守：

- 暂停合并 #26、#28、#30 以及任何会修改主线 UI、工作台、项目详情、流程管理或流程编排的旧分支。
- 不允许把早于当前页面状态创建的旧分支直接合并进 `main`。
- 不允许用 `docs/archive/`、`docs/generated/` 或旧 mockup 覆盖当前已调整页面。
- 当前可继续做：代码审查、问题记录、文档整理、基线规则补充。
- 当前不应做：合并旧 PR、直接覆盖页面样式、在旧分支上继续大范围修 UI。

用户确认页面状态可接受后，必须先提交一个“当前定稿基线” commit。之后所有 #26、#28、#30 等进行中的需求必须基于最新 `origin/main` 重新处理：

1. 干净分支优先 `rebase origin/main`。
2. 混入较多或改动范围不清的分支，从最新 `origin/main` 新建分支后 cherry-pick 必要提交。
3. 合并前必须检查是否回退已定稿页面和交互。

长期规则见：[[../architecture/baseline-branch-and-merge-rules|基线、分支与合并硬规则]]

## 2026-06-05 文档归档与生成产物硬约束

本节是后续所有 Agent、Skill、脚本和人工开发继续工作的最新协同入口，优先级高于本文档后面的历史任务段落。

### 必读规范

- 文档入口：`docs/README.md`
- 文档与产物归档规范：`docs/architecture/document-management-standards.md`
- 设计入口：`docs/design/README.md`

### 后续生成规则

- 不要在仓库根目录生成临时 `*.md`、`*.yaml`、`*.yml`、`*.mjs`、截图、mockup 或一次性脚本。
- Skill / Superpowers / AI 生成的过程文档统一放入 `docs/generated/`，默认不是最终依据。
- 被人工确认采用的内容，必须整理到 `docs/product/`、`docs/architecture/`、`docs/design/` 或 `docs/handoff/`。
- 当前设计稿只参考 `docs/design/mockups/current/` 和 `docs/design/assets/current/`。
- 旧版 mockup、截图和测试产物只放入 `docs/design/*/archive/` 或 `docs/archive/test-artifacts/`。
- 根目录 `mockups/`、`screenshots/`、`test-screenshots/` 不再作为正式目录维护。
- `.codegraph/` 是 Codegraph 工程服务数据与索引，禁止清理、归档或删除。
- `.agentmanagement/`、`.agents/`、`.claude/`、`.superpowers/`、`.worktrees/` 属于本地工程状态，未经明确要求不要清理。

### 提交前检查

- `git status` 中不应出现根目录临时文档、截图、mockup 或脚本。
- 文档路径移动后，必须同步更新引用路径。
- 文档整理应单独提交，不要和业务功能改动混在同一个提交里。
...
**详细计划：** `docs/generated/superpowers/plans/2026-05-30-phase3-ui-integration.md`
...
详见：`docs/generated/superpowers/specs/2026-05-30-issue-workflow.md`
...
- 开始前必须读取当前 Issue、Git 状态、`docs/handoff/handoff-next-tasks.md`
...
- 流程管理总览定稿 HTML: `docs/design/mockups/current/flow-management-overview-v1.html`
- Web 预览副本: `docs/design/mockups/archive/public-mockups/flow-management-overview-v1.html`
...
- AI 流程设计定稿 HTML: `docs/design/mockups/current/ai-workflow-design-v1-final.html`
- Web 预览副本: `docs/design/mockups/archive/public-mockups/ai-workflow-design-v1-final.html`
...
- `AI 建项助手 V1`
  - Final HTML prototype: `docs/design/mockups/current/ai-project-initiation-final.html`
...
- `流程编排 - 常规配置`
  - Final HTML prototype: `docs/design/mockups/current/workflow-builder-regular-final.html`
  - Reference image: `docs/design/assets/current/workflow-builder-dual-mode-v1.png`
...
- The finalized Workflow Management / Workflow Builder design is:
  - image: `docs/design/assets/current/workflow-builder-dual-mode-v1.png`
  - HTML prototype: `docs/design/mockups/current/workflow-builder-dual-mode-v1.html`
- AI Project Initiation / AI 建项 visual is now frozen as v2, after comparing and merging the strengths of:
  - current AI initiation prototype: `docs/design/mockups/current/ai-project-initiation-v1.html`
  - current visual reference image: `docs/design/assets/current/project-management-overview-ai-briefing-v1.png`
  - Project Management overview context: `docs/design/mockups/current/project-management-overview-ai-briefing-v1.html`
...
- AI 建项助手 v2 final visual reference:
  - `docs/design/assets/current/ai-project-initiation-v2-final.png`
- 常规流程设计 v2 final visual reference:
  - `docs/design/assets/current/workflow-conventional-design-v2-final.png`
...
- `docs/design/assets/current/workbench-v1.png`
- `docs/design/assets/current/workflow-builder-dual-mode-v1.png`
...
- Treat `docs/design/mockups/current/workbench-v1.html` and `docs/design/assets/current/workbench-v1.png` as the visual baseline for the whole frontend.
...
- `docs/design/design-tokens.md`
- `docs/frontend/FRONTEND_IMPLEMENTATION_PLAN.md`
- `docs/design/mockups/current/index.html`
- `docs/design/mockups/current/ai-project-initiation-v1.html`
- `docs/design/mockups/current/workbench-v1.html`
- `docs/design/mockups/current/project-management-overview-ai-briefing-v1.html`
- `docs/design/mockups/current/project-detail-gantt-v1.html`
- `docs/design/mockups/current/project-detail-trace-drawer-v1.html`
- `docs/design/mockups/current/workflow-builder-dual-mode-v1.html`
- `docs/design/mockups/current/memory-management-knowledge-center-v1.html`
...
- `docs/design/assets/current/workbench-v1.png`
- `docs/design/assets/current/project-management-overview-ai-briefing-v1.png`
- `docs/design/assets/current/project-detail-gantt-v1.png`
- `docs/design/assets/current/project-detail-trace-drawer-v1.png`
- `docs/design/assets/current/workflow-builder-dual-mode-v1.png`
- `docs/design/assets/current/memory-management-knowledge-center-v1.png`
...
1. **设计图对齐审查**：已完成 `docs/design/design-vs-implementation-gap.md`，详见下文"设计差距摘要"。
...
2026-05-17 对 6 张设计图与当前实现进行逐图对比审查，结果已写入 `docs/design/design-vs-implementation-gap.md`。
...
| 优先级 | 规格文件 |
|--------|----------|
| P0 | `docs/generated/superpowers/specs/2026-05-15-project-management-merge-design.md` |
| P0 | `docs/generated/superpowers/specs/2026-05-15-workflow-consolidation-design.md` |
| P1a | `docs/generated/superpowers/specs/2026-05-15-im-adapter-design.md` |
| P1b | `docs/generated/superpowers/specs/2026-05-15-git-devops-integration-design.md` |
| P2 | `docs/generated/superpowers/specs/2026-05-15-frontend-engineering-standards-design.md` |
| P3 | `docs/generated/superpowers/specs/2026-05-16-workflow-canvas-design.md` |
| P4 | `docs/generated/superpowers/specs/2026-05-16-project-management-v3-design.md` |
| P4-WS | `docs/generated/superpowers/specs/2026-05-16-project-workspace-v2-design.md` |
| P5 | `docs/generated/superpowers/specs/2026-05-16-role-markdown-design.md` |
| P6 | `docs/generated/superpowers/specs/2026-05-16-ai-assistant-design.md` |
| P7 | `docs/generated/superpowers/specs/2026-05-15-git-devops-integration-design.md` |
...
2. 按 `docs/design/page-spec.md` 补齐页面、组件、状态和交互。
...
- 视觉参考：`docs/design/assets/current/memory-management-knowledge-center-v1.png`。
...
- `docs/design/assets/current/ai-workflow-design-v1-final.png`
...
- `docs/design/mockups/current/project-management-overview-v2-full.html`
- `docs/design/mockups/archive/public-mockups/project-management-overview-v2-full.html`
...
- `docs/design/mockups/current/project-management-overview-v2-final.html`
- `docs/design/mockups/archive/public-mockups/project-management-overview-v2-final.html`
...
- Gantt / health cockpit HTML: `docs/design/mockups/current/project-detail-gantt-v1.html`
- Trace drawer HTML: `docs/design/mockups/current/project-detail-trace-drawer-v1.html`
...
- `docs/design/mockups/current/project-detail-gantt-v1.html`
- `docs/design/mockups/current/project-detail-trace-drawer-v1.html`
- `docs/design/mockups/archive/public-mockups/project-detail-gantt-v1.html`
...
- `docs/design/mockups/current/project-detail-tabs-v1.html`
...
- `docs/design/mockups/current/project-detail-trace-drawer-v1.html` 已合并项目详情 7 个分页，作为项目详情页当前定稿入口。
- Public preview: `http://127.0.0.1:5173/mockups/project-detail-trace-drawer-v1.html`
- `docs/design/mockups/current/project-detail-tabs-v1.html` 仅保留为分页内容参考，不再作为主入口。
...
- `docs/design/mockups/current/ai-project-initiation-v2-final.html`
- `docs/design/mockups/archive/public-mockups/ai-project-initiation-v2-final.html`
