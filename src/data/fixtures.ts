      ...
      steps: [
        {
          ...
          name: "需求分析",
          assignments: [{
            id: "step-001-assign-0",
            order: 0,
            roleId: "role-001",
            runnerId: "runner-claude-code",
            modelProviderId: "provider-deepseek",
            modelName: "deepseek-v4-pro",
            goal: "分析用户需求，输出需求规格摘要",
            acceptanceCriteria: ["功能列表完整", "优先级明确", "风险标注"],
            inputs: ["项目背景", "用户需求"],
            outputs: ["需求规格摘要"],
            dependsOnAssignmentIds: [],
            notifyAssignmentIds: ["step-002-assign-0"],
            eventRoutes: [{ trigger: "task_completed", action: "unblock_task", targetAssignmentId: "step-002-assign-0" }],
          }],
          inputs: ["项目背景", "用户需求"],
          outputs: ["需求规格摘要"],
          gateMode: "manual",
...
- 高风险需求必须在摘要中标注风险等级`,
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            goal: "基于需求规格完成界面设计",
            acceptanceCriteria: ["设计稿完整", "交互流程清晰"],
            inputs: ["需求规格摘要"],
            outputs: ["设计稿", "设计规格"],
            dependsOnAssignmentIds: ["step-001-assign-0"],
            notifyAssignmentIds: ["step-003-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["需求规格摘要"],
          outputs: ["设计稿", "设计规格"],
        ...
        },
        {
          ...
          name: "前端开发",
          assignments: [{
            id: "step-003-assign-0",
            order: 0,
            roleId: "role-003",
            runnerId: "runner-codex-cli",
            modelProviderId: "provider-openai",
            modelName: "gpt-5.3-codex",
            goal: "实现前端组件和页面",
            acceptanceCriteria: ["代码通过审查", "测试覆盖"],
            inputs: ["设计规格"],
            outputs: ["组件代码", "页面实现"],
            dependsOnAssignmentIds: ["step-002-assign-0"],
            notifyAssignmentIds: ["step-004-assign-0"],
            eventRoutes: [],
          }, {
            id: "step-003-assign-1",
            order: 1,
            roleId: "role-003",
            runnerId: "runner-claude-code",
            modelProviderId: "provider-deepseek",
            modelName: "deepseek-v4-pro",
            goal: "实现后端 API 和业务逻辑",
            acceptanceCriteria: ["API 通过集成测试", "业务逻辑正确"],
            inputs: ["设计规格"],
            outputs: ["后端代码", "API 实现"],
            dependsOnAssignmentIds: ["step-002-assign-0"],
            notifyAssignmentIds: ["step-004-assign-0"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            goal: "审查代码质量和安全性",
            acceptanceCriteria: ["无高危漏洞", "符合规范"],
            inputs: ["组件代码", "页面实现"],
            outputs: ["审查意见"],
            dependsOnAssignmentIds: ["step-003-assign-0", "step-003-assign-1"],
            notifyAssignmentIds: ["step-005-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["组件代码", "页面实现"],
          outputs: ["审查意见"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            goal: "执行功能测试和回归测试",
            acceptanceCriteria: ["测试报告通过", "无阻塞性缺陷"],
            inputs: ["审查后的代码"],
            outputs: ["测试报告"],
            dependsOnAssignmentIds: ["step-004-assign-0"],
            notifyAssignmentIds: [],
            eventRoutes: [],
          }],
          inputs: ["审查后的代码"],
      ...
      steps: [
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            goal: "提交设计方案",
            acceptanceCriteria: ["设计说明完整"],
            inputs: ["设计稿"],
            outputs: ["设计说明"],
            dependsOnAssignmentIds: [],
            notifyAssignmentIds: ["dr-step-002-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["设计稿"],
          outputs: ["设计说明"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            inputs: ["设计说明"],
            outputs: ["评审意见"],
            dependsOnAssignmentIds: ["dr-step-001-assign-0"],
            notifyAssignmentIds: ["dr-step-003-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["设计说明"],
          outputs: ["评审意见"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            inputs: ["评审意见"],
            outputs: ["修改后设计"],
            dependsOnAssignmentIds: ["dr-step-002-assign-0"],
            notifyAssignmentIds: ["dr-step-004-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["评审意见"],
          outputs: ["修改后设计"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            goal: "确认设计通过",
            acceptanceCriteria: ["评审结论明确"],
            inputs: ["修改后设计"],
            outputs: ["评审结论"],
            dependsOnAssignmentIds: ["dr-step-003-assign-0"],
            notifyAssignmentIds: [],
            eventRoutes: [],
          }],
          inputs: ["修改后设计"],
      ...
      steps: [
        {
          ...
          assignments: [{
            ...
            outputs: ["根因分析"],
            dependsOnAssignmentIds: [],
            notifyAssignmentIds: ["bf-step-002-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["问题描述"],
          outputs: ["根因分析"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            goal: "制定修复方案",
            acceptanceCriteria: ["方案可行"],
            inputs: ["根因分析"],
            outputs: ["修复方案"],
            dependsOnAssignmentIds: ["bf-step-001-assign-0"],
            notifyAssignmentIds: ["bf-step-003-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["根因分析"],
          outputs: ["修复方案"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            inputs: ["修复方案"],
            outputs: ["修复代码"],
            dependsOnAssignmentIds: ["bf-step-002-assign-0"],
            notifyAssignmentIds: ["bf-step-004-assign-0"],
            eventRoutes: [],
          }],
          inputs: ["修复方案"],
          outputs: ["修复代码"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            inputs: ["修复代码"],
            outputs: ["验证报告"],
            dependsOnAssignmentIds: ["bf-step-003-assign-0"],
            notifyAssignmentIds: [],
            eventRoutes: [],
          }],
          inputs: ["修复代码"],
