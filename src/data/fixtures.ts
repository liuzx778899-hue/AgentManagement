      ...
      steps: [
        {
          ...
          assignments: [{
            ...
            modelProviderId: "provider-deepseek",
            modelName: "deepseek-v4-pro",
            taskGoal: "分析用户需求，输出需求规格摘要",
            acceptanceCriteria: ["需求范围明确", "功能列表完整", "优先级标注清晰"],
            inputs: ["项目背景", "用户需求"],
            outputs: ["需求规格摘要"],
            ...
            eventRoutes: [{
              id: "route-001",
              on: "task_completed",
              target: { type: "assignment", id: "step-002-assign-0" },
              action: "notify",
            }],
...
- 高风险需求必须在摘要中标注风险等级`,
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            taskGoal: "根据需求规格设计界面",
            acceptanceCriteria: ["设计稿完整", "交互逻辑清晰"],
            inputs: ["需求规格摘要"],
            outputs: ["设计稿", "设计规格"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "gpt-5.3-codex",
            taskGoal: "实现前端组件和页面",
            acceptanceCriteria: ["组件可运行", "样式符合设计"],
            inputs: ["设计规格"],
            outputs: ["组件代码", "页面实现"],
        ...
        },
        {
          ...
          assignments: [{
            ...
            modelName: "deepseek-v4-pro",
            taskGoal: "执行测试验证",
            acceptanceCriteria: ["测试覆盖完整", "无阻塞性Bug"],
            inputs: ["审查后的代码"],
            outputs: ["测试报告"],
